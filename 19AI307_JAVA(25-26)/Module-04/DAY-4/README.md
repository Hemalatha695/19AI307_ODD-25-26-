...
3.	Create concrete classes Circle, Square, and Rectangle implementing Shape.
4.Create a ShapeFactory class with a method getShape(String shapeType).
5.In the main() method, accept user input for shape type.
6.Call factory method to get the appropriate object.
7.Draw the shape or print error if unknown.
8.Stop the program.
...
## OUTPUT:
<img width="657" height="470" alt="java44" src="https://github.com/user-attachments/assets/dd375a96-f271-43c9-ac92-755794e2341c" />
